# Canonical Terms — VAIOS Research Program

Last updated: 2026-03-02
Maintained by: Fábio Priebe Carvalho (ORCID: 0009-0002-8326-8434)

---

Terms are listed in order of articulation date.
Each term has: name, definition, date, evidence, status.

## Terms

### Generative potency
**Definition:** The capacity of a minimal declaration to produce maximal correct behavior derivation in an AI-operated system.
**Date:** 2026-02 · **Evidence:** VAIOS Protocol Spec v1.0
**Status:** Published (protocol spec)

### Semantic compression ratio
**Definition:** The ratio between tokens declared in an instruction and correct behaviors derivable by an AI agent.
**Date:** 2026-02 · **Evidence:** VAIOS Protocol Spec v1.0
**Status:** Published (protocol spec)

### Governance inheritance scaling
**Definition:** An organizational scaling mechanism where new units inherit the complete governance kernel at instantiation with zero marginal compliance cost.
**Date:** 2026-02 · **Evidence:** VAIOS Protocol Spec v1.0
**Status:** Published (protocol spec)

### Operator hierarchy
**Definition:** Functional hierarchy of AI agents (H1: governance, H2: infrastructure, H3: operations) that operate within organizational systems with declared roles and governance inheritance.
**Date:** 2026-02 · **Evidence:** VAIOS implementation (Dorano)
**Status:** In use (VAIOS instance)

### Embedded governance
**Definition:** Governance mechanism where rules from a governance charter are propagated into operational entities via skills with governance_source traceability, ensuring runtime enforcement matches declared governance.
**Date:** 2026-02 · **Evidence:** VAIOS implementation (Dorano)
**Status:** In use (VAIOS instance)
